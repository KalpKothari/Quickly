...
import {
  FileText, Image as ImageIcon, Video, Music, Share2, GraduationCap, Type, Wrench,
  ...
  Film, Copy, Volume2, Rewind, Infinity as InfinityIcon, PlayCircle, VolumeX,
  ScissorsSquare, Waves,
  Instagram, Youtube, Facebook, Twitter, Linkedin, Pin as PinIcon, ImagePlay, User,
  Type as TypeIcon, Hash, KeyRound,
  Ruler, Coins, Cake, Percent, Activity, Calculator, Globe, Link2, CalendarClock, Timer, Clock, TimerReset,
  Award, CalendarCheck,
} from "lucide-react";

export type CategoryId =
  | "pdf" | "image" | "video" | "audio" | "social" | "student" | "text" | "utility";
...
export const CATEGORIES: Category[] = [
  ...
  { id: "video", slug: "videos", name: "Video Utilities", tagline: "Trim, crop, convert & reverse", icon: Video, color: "cat-video", gradient: "from-fuchsia-500/15 to-rose-500/10" },
...
export const TOOLS: Tool[] = [
  ...
  // Social
  { slug: "youtube-thumbnail", name: "YouTube Thumbnail Downloader", description: "Download any YouTube video thumbnail in HD.", category: "social", icon: Youtube, status: "live", popular: true, featured: true },
  { slug: "instagram-reel", name: "Instagram Reel Downloader", description: "Download public Instagram reels.", category: "social", icon: ImagePlay, status: "soon", popular: true },
 ...
 { slug: "youtube-video", name: "YouTube Video Downloader", description: "Download YouTube videos as MP4.", category: "social", icon: Youtube, status: "soon", popular: true, featured: true },
  { slug: "youtube-mp3", name: "YouTube MP3 Downloader", description: "Extract YouTube audio as MP3.", category: "social", icon: Music, status: "soon", popular: true },
  ...
  { slug: "attendance-calculator", name: "Attendance Calculator", description: "Track attendance and see bunkable classes.", category: "student", icon: CalendarCheck, status: "live", popular: true },
  ...
  { slug: "currency-converter", name: "Currency Converter", description: "Live currency conversion with INR support.", category: "utility", icon: Coins, status: "live", featured: true },
  ...
  { slug: "emi-calculator", name: "EMI Calculator", description: "Indian-standard EMI with amortization.", category: "utility", icon: Calculator, status: "live", popular: true, featured: true },
  { slug: "loan-calculator", name: "Loan Calculator", description: "Estimate loan cost, interest and tenure.", category: "utility", icon: Calculator, status: "live" },
